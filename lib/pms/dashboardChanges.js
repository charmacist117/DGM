...
export const DASHBOARD_CHANGE_SEEDS = [
  ...
  {
    key: "pharmadev_dashboard_changelog_seed_20260908_56", id: "dashboard_change_20260908_pricing_tab_copy",
    changes: [
      "유통 구조 설정에서 작성한 가격대 탭을 복사해 다른 제품의 가격대 탭으로 붙여넣을 수 있도록 개선했습니다."
    ]
  },
  {
    key: "pharmadev_dashboard_changelog_seed_20260909_57", id: "dashboard_change_20260909_ytd_start_date",
    changes: [
      "시장 규모 분석의 YTD 기준에 시작일을 추가해 지정일부터 해당 연도 말일까지를 Year 1로, 다음 해 전체를 Year 2로 추산할 수 있도록 개선했습니다.",
      "YTD 시작일이 바뀌면 선택한 5개년 또는 최근 3개년 연평균 성장률과 남은 기간을 함께 반영해 예상 소진수량과 손익을 다시 계산합니다."
    ]
  },
  {
    key: "pharmadev_dashboard_changelog_seed_20260914_58", id: "dashboard_change_20260914_cosmetics_category",
    changes: [
      "공급단가부터 유통 구조 설정·시장 규모 분석·프로젝트 추진까지 화장품 카테고리를 추가했습니다."
    ]
  },
  {
    key: "pharmadev_dashboard_changelog_seed_20260923_59", id: "dashboard_change_20260923_task_row_delete",
    changes: [
      "제품일정관리 및 간트차트의 태스크 관리 수정 화면에서 각 태스크 행을 삭제할 수 있도록 개선했습니다."
    ]
  },
  {
    key: "pharmadev_dashboard_changelog_seed_20260923_60", id: "dashboard_change_20260923_stopped_promotion_sort",
    changes: [
      "프로젝트 추진의 전체 목록에서 진행 중단 품목을 맨 아래로 정렬하고, 기존 중단 필터로 따로 모아볼 수 있도록 개선했습니다."
    ]
  },
  {
    key: "pharmadev_dashboard_changelog_seed_20260923_61", id: "dashboard_change_20260923_promotion_rounded_cost",
    changes: [
      "프로젝트 추진의 최종 공급원가를 소수 첫째 자리까지 표시하고, 최소 주문 생산비와 총 예상비용을 표시 단가 기준으로 계산하도록 수정했습니다."
    ]
  }
];
