...
export function calculateMarketAnalysis(item = {}, rawAnalysis = {}, rawDefaults = {}) {
  ...
  const depletionMonthsPerBatch = annualDemandUnits && orderQuantity
    ...
    : null;
  const batchCapital = baseUnitCost !== null && orderQuantity !== null
    ? baseUnitCost * orderQuantity
    : null;
  const averageInventoryUnits = annualDemandUnits !== null && orderQuantity !== null
    ...
    : null;
  const averageInventoryCapital = averageInventoryUnits !== null && baseUnitCost !== null
    ? averageInventoryUnits * baseUnitCost
    : null;
  ...
  const chamyaksaSellingPrice = distributionSellingPrice !== null
    ...
    : null;
  const marginPerUnit = chamyaksaSellingPrice !== null && baseUnitCost !== null
    ? chamyaksaSellingPrice - baseUnitCost
    : null;
