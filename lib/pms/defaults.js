...
const PRODUCT_SUPPLY_SHEET_DEFAULTS = {
  manufacturer: "",
  permitCompany: "",
  ingredientName: "",
  ingredientContent: "",
...
export function createEmptyProductSupplySheet() {
  return {
    ...PRODUCT_SUPPLY_SHEET_DEFAULTS
  };
}

export function normalizeProductSupplySheet(value = {}) {
...
export function createProjectFromForm({
  ...
  return {
    ...
    permitCompany,
    manufacturer,
    productSupplySheet: normalizeProductSupplySheet({ manufacturer, permitCompany }),
